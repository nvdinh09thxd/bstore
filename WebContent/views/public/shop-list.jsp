								...
								<ul class="gategory-product">
									...
									<li class="cat-product-list">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="single-product-item">
												<div class="product-image">
													<a href="single-product.html"><img src="<%=request.getContextPath() %>/templates/public/img/product/sale/1.jpg" alt="product-image" /></a>
									...
									<li class="cat-product-list">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="single-product-item">
												<div class="product-image">
													<a href="single-product.html"><img src="<%=request.getContextPath() %>/templates/public/img/product/sale/9.jpg" alt="product-image" /></a>
													<a href="single-product.html" class="new-mark-box">Sale!</a>
												</div>
											</div>
										</div>
									...
									<li class="cat-product-list">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="single-product-item">
												<div class="product-image">
													<a href="single-product.html"><img src="<%=request.getContextPath() %>/templates/public/img/product/sale/5.jpg" alt="product-image" /></a>
													<a href="single-product.html" class="new-mark-box">Sale!</a>
												</div>
											</div>
										</div>
									...
									<li class="cat-product-list">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="single-product-item">
												<div class="product-image">
													<a href="single-product.html"><img src="<%=request.getContextPath() %>/templates/public/img/product/sale/12.jpg" alt="product-image" /></a>
													<a href="single-product.html" class="new-mark-box">new</a>
												</div>
											</div>
										</div>
									...
									<li class="cat-product-list">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="single-product-item">
												<div class="product-image">
													<a href="single-product.html"><img src="<%=request.getContextPath() %>/templates/public/img/product/sale/13.jpg" alt="product-image" /></a>
													<a href="single-product.html" class="new-mark-box">new</a>
												</div>
											</div>
										</div>
									...
									<li class="cat-product-list">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="single-product-item">
												<div class="product-image">
													<a href="single-product.html"><img src="<%=request.getContextPath() %>/templates/public/img/product/sale/11.jpg" alt="product-image" /></a>
													<a href="single-product.html" class="new-mark-box">new</a>
												</div>
											</div>
										</div>
									...
									<li class="cat-product-list">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="single-product-item">
												<div class="product-image">
													<a href="single-product.html"><img src="<%=request.getContextPath() %>/templates/public/img/product/sale/2.jpg" alt="product-image" /></a>
													<a href="single-product.html" class="new-mark-box">new</a>
												</div>
											</div>
										</div>
									...
									<li class="cat-product-list">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="single-product-item">
												<div class="product-image">
													<a href="single-product.html"><img src="<%=request.getContextPath() %>/templates/public/img/product/sale/4.jpg" alt="product-image" /></a>
													<a href="single-product.html" class="new-mark-box">new</a>
												</div>
											</div>
										</div>
									...
									<li class="cat-product-list">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="single-product-item">
												<div class="product-image">
													<a href="single-product.html"><img src="<%=request.getContextPath() %>/templates/public/img/product/sale/7.jpg" alt="product-image" /></a>
													<a href="single-product.html" class="new-mark-box">new</a>
												</div>
											</div>
										</div>
									...
									<li class="cat-product-list">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="single-product-item">
												<div class="product-image">
													<a href="single-product.html"><img src="<%=request.getContextPath() %>/templates/public/img/product/sale/10.jpg" alt="product-image" /></a>
													<a href="single-product.html" class="new-mark-box">new</a>
												</div>
											</div>
										</div>
									...
									<li class="cat-product-list">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
											<div class="single-product-item">
												<div class="product-image">
													<a href="single-product.html"><img src="<%=request.getContextPath() %>/templates/public/img/product/sale/6.jpg" alt="product-image" /></a>
													<a href="single-product.html" class="new-mark-box">new</a>
												</div>
											</div>
										</div>

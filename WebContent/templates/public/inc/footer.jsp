<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
										...
										<div class="Store-Information">
											...
											<ul>
												<li>
													...
													<div class="info-text">
														<p>My Company, 42 avenue des Champs Elys̩es 75000 Paris France </p>
													</div>
												</li>
												<li>
													<div class="info-lefticon">
								...
								<div class="row">
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										...
										<div class="payment-method">
											<img class="img-responsive pull-right" src="<%=request.getContextPath() %>/templates/public/img/payment.png" alt="payment-method" />
										</div>
										<!-- PAYMENT-METHOD END -->
									</div>
								</div>
		...
		<!-- fancybox js -->
        <script src="<%=request.getContextPath() %>/templates/public/js/jquery.fancybox.js"></script>
		
		<!-- bxslider js -->
        <script src="<%=request.getContextPath() %>/templates/public/js/jquery.bxslider.min.js"></script>
		
		<!-- meanmenu js -->
        <script src="<%=request.getContextPath() %>/templates/public/js/jquery.meanmenu.js"></script>
		
		<!-- owl carousel js -->
        <script src="<%=request.getContextPath() %>/templates/public/js/owl.carousel.min.js"></script>
		
		<!-- nivo slider js -->
        <script src="<%=request.getContextPath() %>/templates/public/js/jquery.nivo.slider.js"></script>
		
		<!-- jqueryui js -->
        <script src="<%=request.getContextPath() %>/templates/public/js/jqueryui.js"></script>
